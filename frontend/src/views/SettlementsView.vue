...
<template>
  <div class="space-y-6">
    <div class="bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 rounded-card p-8 mb-8 shadow-card-hover border border-slate-800 relative overflow-hidden group">
      <!-- Decor -->
