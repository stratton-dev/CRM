...
const generateFullHtml = (ctx: RenderContext) => {
  ...
  return `
    ...
    <head>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700&family=DM+Sans:ital,wght@0,400;0,500;0,700;1,400&display=swap" rel="stylesheet">
      <style>
    ...
    <body>
      ${CoverPage(firma, date, meta)}
      ${TableOfContents(meta, date, firma, advisor)}
