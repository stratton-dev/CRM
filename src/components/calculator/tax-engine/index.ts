...
import { WynikWariantuPodzial, WynikWariantuStandard } from '../models/calculation';
...
export const obliczWariantPodzial = (
  pracownik: Pracownik,
  stawkaWypadkowa: number,
  nettoZasadnicza: number,
  config: Config
): WynikWariantuPodzial => {
  ...
  const pitCalkowity = obliczPit(podstawaPitCalkowita, pracownik.pit2, pracownik.ulgaMlodych, stawkaPitFinal);
