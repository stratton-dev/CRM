...
<template>
  <div class="flex flex-col h-[calc(100vh-112px)]">
    ...
    <div class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4">
      <div v-if="isManagerView && selectedRep" class="flex items-center">
        <button
          type="button"
          class="text-xs text-stratton-gold hover:text-amber-700 font-bold flex items-center transition-colors uppercase tracking-widest"
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-white border border-slate-200 p-4 rounded-card shadow-sm">
          <div class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Suma prowizji (ten miesiąc)</div>
          <div class="text-xl md:text-3xl font-bold text-slate-800 font-serif">{{ structureTotalCommission.toFixed(2) }} <span class="text-stratton-gold text-lg">PLN</span></div>
        </div>
        <div class="bg-white border border-slate-200 p-4 rounded-card shadow-sm">
          <div class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Wypłacono</div>
          <div class="text-xl md:text-3xl font-bold text-slate-800 font-serif">0.00 <span class="text-emerald-600 text-lg">PLN</span></div>
        </div>
        <div class="bg-white border border-slate-200 p-4 rounded-card shadow-sm">
          <div class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Do wypłaty</div>
          <div class="text-xl md:text-3xl font-bold text-slate-800 font-serif">{{ totalCommission.toFixed(2) }} <span class="text-stratton-gold text-lg">PLN</span></div>
        </div>
      </div>
